-- Knowledge Corpus Schema for RAG (Retrieval-Augmented Generation)
-- This migration creates tables for Google Drive folder syncing with vector embeddings
...
CREATE INDEX idx_oauth_owner ON oauth_credentials(owner_user_id);
...
CREATE INDEX idx_drive_sources_owner ON drive_sources(owner_user_id);
CREATE INDEX idx_drive_sources_oauth ON drive_sources(oauth_credential_id);
...
CREATE INDEX idx_corpora_drive_source ON corpora(drive_source_id);
CREATE INDEX idx_corpora_sync_status ON corpora(sync_status);
...
CREATE INDEX idx_documents_drive_file ON documents(google_drive_file_id);
CREATE INDEX idx_documents_status ON documents(indexing_status);
CREATE INDEX idx_documents_modified ON documents(drive_modified_at);
...
CREATE INDEX idx_ingestion_jobs_corpus ON ingestion_jobs(corpus_id);
...
CREATE INDEX idx_retrieval_audit_corpus ON retrieval_audit(corpus_id);
CREATE INDEX idx_retrieval_audit_created ON retrieval_audit(created_at DESC);
