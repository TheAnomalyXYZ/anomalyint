...
export function Overview() {
  ...
  const loadTodaysContext = async (): Promise<string> => {
    try {
      ...
      // Format context: question title + agent description
      if (todaysQuestions.length === 0) {
        const emptyContext = "No questions have been generated by AI agents today yet.";
      ...
      const contextText = `Today's AI-Generated Questions (${todaysQuestions.length}):\n${contextLines.join('\n')}`;
...
${currentContext ? `Context about today's AI-generated questions:\n${currentContext}\n\n` : ''}
...
${todaysContext ? `Context about today's AI-generated questions:\n${todaysContext}\n\n` : ''}
